...
export type BlockProductsCarouselLayout =
  | 'grid-4'
  | 'grid-4-sidebar'
  | 'grid-5'
  | 'grid-6'
...
export class BlockProductsCarouselComponent
  implements OnChanges, OnInit, OnDestroy
{
  ...
  layout: BlockProductsCarouselLayout = 'grid-4';
  ...
  @Output() changeGroup: EventEmitter<SectionHeaderGroup> =
    new EventEmitter<SectionHeaderGroup>();

  @HostBinding('class.block') classBlock = true;

  @HostBinding('class.block-products-carousel') classBlockProductsCarousel =
    true;
