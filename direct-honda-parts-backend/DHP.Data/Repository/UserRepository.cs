...
namespace DHP.Data.Repository
{
    public class UserRepository : Helper, IUserRepository
    {
        ...
        public Task<User> GetUserBasedOnResetToken(string resetToken)
        {
            ...
            }, GetUserByResetTokenSp);
        }

        public Task<dynamic> CreateNewUser(User user)
        {
            return db.BasicQueryOperation(new
            {
                EMAIL = user.Email,
        ...
        {
            return DoUnitOfWork(() => db.BasicOperation(new
            {
                ID = user.Id,
                EMAIL = user.Email,
                FIRSTNAME = user.FirstName ?? "",
        ...
        {
            return db.GetInfo<ExpiredKeys>(new
            {
                EXPIREDKEY = key
            }, GetExpiredKeySp);
        }
        ...
        {
            return db.GetInfoList<UserAddress>(new
            {
                USERID = userId,
                ID = Id,
        ...
        {
            return db.GetInfoList<UserProfile>(new
            {
                USERID = userId
            }, GetUserProfileSp);
        }
