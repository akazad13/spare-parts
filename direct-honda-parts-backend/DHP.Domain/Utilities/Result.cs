...
namespace DHP.Domain.Utilities
{
    ...
    //    public static IResult<Unit> Error(string msg) => new Error<Unit>(new GenericResponse(msg));

    //    public static IResult<Unit> SystemError(string msg) => new Error<Unit>(new GenericResponse($"System Error: {msg}"));
    //}
}
