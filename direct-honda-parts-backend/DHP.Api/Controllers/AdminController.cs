    ...
    public class AdminController : BaseController
    {
        ...
        public IActionResult GetUserProfile(long adminId, long userId)
        {
            return DoWorkAfterValidation(
                         () => _accountService.GetUserProfile(GetCurrentUserId(), userId, adminId).Result
                            .Match<IActionResult>(
                                Ok,
                                BadRequest
                            )
        ...
        {
            return DoWorkAfterValidation(
                         () => _accountService.Register(GetCurrentUserId(), profileData, adminId).Result
                            .Match<IActionResult>(
                                Ok,
                                BadRequest
                            )
        ...
        [Route("{adminId}/users/{userId}/profile")]
        [Authorize(Policy = "RequireAdminRole")]
        public IActionResult UpdateUserProfile(long adminId, long userId, UserProfileDto profileData)
        {
            return DoWorkAfterValidation(
                         () => _accountService.UpdateUserProfile(GetCurrentUserId(), userId, profileData, adminId).Result
                            .Match<IActionResult>(
                                Ok,
                                BadRequest
                            )
        ...
        {
            return DoWorkAfterValidation(
                         () => _accountService.DeleteUser(GetCurrentUserId(), userId, adminId).Result
                            .Match<IActionResult>(
                                Ok,
                                BadRequest
                            )
