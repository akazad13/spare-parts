...
namespace DHP.Api.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            return (await _accountService.LogInService(loginData, false))
                  .Match<IActionResult>(
                        Ok,
                        BadRequest
                   );
        ...
        {
            return (await _accountService.MakeKeyExpire(GetTokenIdClaim()))
                   .Match<IActionResult>(
                        Ok,
                        BadRequest
                    );
        ...
        {
            return (await _accountService.ResetPasswordWithResetToken(resetPassword.NewPassword, resetPassword.ResetToken))
                   .Match<IActionResult>(
                       Ok,
                       BadRequest
                   );
